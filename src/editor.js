...
export function editorInit(doc = '') {
  ...
  // World IR files are YAML (World Kernel whitepaper's data format, e.g. the
  // state_machine documents smview.js renders) -- everything else stays
  // Markdown, this app's original content type.
