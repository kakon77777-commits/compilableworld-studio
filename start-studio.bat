@echo off
REM ============================================================
REM  CompilableWorld Studio launcher — double-click to run.
...
echo.
echo Starting CompilableWorld Studio... the browser will open automatically.
